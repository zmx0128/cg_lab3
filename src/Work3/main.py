...
def draw_curve_kernel(n: ti.i32):
    ...
    for i in range(n):
        ...
        if 0 <= x_pixel < WIDTH and 0 <= y_pixel < HEIGHT:
            pixels[x_pixel, y_pixel] = ti.Vector([0.8, 0.2, 0.4])
...
def main():
    ...
    while window.running:
        ...
        if current_count > 0:
            ...
            canvas.circles(gui_points, radius=0.005, color=(0.95, 0.8, 0.8))
            ...
            if current_count >= 2:
                ...
                canvas.lines(gui_points, width=0.002, indices=gui_indices, color=(1.0, 0.5, 0.5))
